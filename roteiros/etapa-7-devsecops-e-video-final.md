...
Para garantir que a avaliação individual seja justa e rastreável pelo professor Silvio, a apresentação foi dividida conforme a contribuição de cada integrante nas etapas do projeto:
...
*   **🎬 LINK DO VÍDEO NO YOUTUBE (NÃO-LISTADO):** [Clique aqui para assistir à apresentação do Projeto Nexora](https://youtu.be/ymXCjyaFniA)
